...
;; def-like things
;; :read queries/clojure/clojure.core.defs.txt
(list_lit
 .
...
"declare" "def" "definline" "definterface" "defmacro" "defmethod" "defmulti" "defn" "defn-" "defonce" "defprotocol" "defrecord" "defstruct" "deftype" "ns"
))

;; other macros
;; :read queries/clojure/clojure.core.macros.txt
(list_lit
 .
 (sym_lit) @function.macro
 (#any-of? @function.macro
